...
cdef class ApproachRTD(Approach):
    ...
    cdef void generate_row_1st_order_kernel(self, long_t, long_t, KernelHandlerRTD) noexcept nogil
    cdef void generate_row_1st_energy_kernel(self, long_t, long_t, KernelHandlerRTD) noexcept nogil
    cdef void generate_row_2nd_energy_kernel(self, long_t, long_t, KernelHandlerRTD) noexcept nogil
    cdef void generate_matrix_element_2nd_order(self, long_t, long_t, KernelHandlerRTD) noexcept nogil
    cdef void generate_col_nondiag_kern_1st_order_dn(self, long_t, long_t, long_t, KernelHandlerRTD) noexcept nogil
    cdef void generate_col_nondiag_kern_1st_order_nd(self, long_t, long_t, KernelHandlerRTD) noexcept nogil
    cdef void generate_row_inverse_Liouvillian(self, long_t, long_t, long_t, KernelHandlerRTD) noexcept nogil
