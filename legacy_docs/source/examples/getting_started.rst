...
#. Read the qualitative prediction before running the calculation.
#. Execute the cells in order.
#. Compare the result with the prediction.
#. Keep the normalization, conservation, equilibrium, and convergence checks.
#. Read the validity section before adapting the model to research parameters.
